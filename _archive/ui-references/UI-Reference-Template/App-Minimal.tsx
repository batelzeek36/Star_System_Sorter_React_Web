...
import {
  ...
  SiriusCrest,
  LyraCrest,
} from "./components/s3/StarSystemCrests";
    ...
    <div className="min-h-screen bg-[var(--s3-canvas-dark)] text-white overflow-auto">
      ...
      <div className="max-w-[1400px] mx-auto p-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-[var(--s3-text-muted)]">
            Essential UI patterns for screen generation
          </p>
        </div>

        {/* Core Screens Grid */}
        <section className="mb-12">
          <h2 className="text-2xl mb-6 text-[var(--s3-lavender-300)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="relative z-10 flex-1 space-y-4 mb-8">
                  <Card variant="emphasis">
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-[var(--s3-lavender-600)] flex items-center justify-center text-sm">
                        1
                      </div>
                      <div>
                  ...
                  <Card>
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 rounded-full bg-[var(--s3-surface-muted)] flex items-center justify-center text-sm">
                        2
                      </div>
                      <div>
                        <p className="font-medium mb-1">Compute Chart</p>
                        <p className="text-xs text-[var(--s3-text-muted)]">
                          Retrieve Human Design data
                        </p>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[var(--s3-text-muted)]">
                          Your star system classification
                        </p>
                      </div>
                    </div>
                  </Card>
            ...
            <div>
              ...
              >
                ...
                <div className="relative z-10 flex-1 space-y-4">
                  ...
                  <Card variant="emphasis">
                    <p className="text-xs text-[var(--s3-text-muted)]">
                      <strong className="text-[var(--s3-lavender-300)]">
                        Privacy:
                      </strong>{" "}
                      Your data is used only for chart computation and never
                      stored or shared.
                    </p>
                  </Card>
                </div>
            ...
            <div>
              ...
              >
                ...
                {/* System Name */}
                <div className="relative z-10 text-center mb-6">
                  <h3 className="text-2xl text-[var(--s3-lavender-300)] mb-2">
                    Pleiades
                  </h3>
                  <p className="text-sm text-[var(--s3-text-muted)]">
                ...
                <Card variant="emphasis" className="relative z-10 mb-4">
                  <p className="text-xs text-[var(--s3-text-muted)] mb-3">
                    System Alignment
                  </p>
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-[var(--s3-text-muted)]">
                        Sirius
                      </span>
                      <span className="text-sm text-[var(--s3-text-muted)]">
                        22%
                ...
                {/* Allies */}
                <div className="relative z-10 mb-6">
                  <p className="text-xs text-[var(--s3-text-muted)] mb-2">
                    Allied Systems
                  </p>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Buttons */}
            <Card>
              <p className="text-sm text-[var(--s3-text-muted)] mb-4">
                Buttons
              </p>
