...
type Screen = 'onboarding' | 'input' | 'result' | 'why' | 'whyRedesign' | 'community' | 'profile' | 'paywall' | 'settings' | 'emptyStates' | 'gameHub' | 'teamSelect' | 'modeSelect' | 'lobby' | 'hudSurvivor' | 'hudRunner' | 'matchResult' | 'leaderboard' | 'musicTheme' | 'questsPass';
