...
- `claude/Full Pass/gate-{N}-full.json` - Complete Line Companion text for all 6 lines (non-padded)
- `claude/I-Ching-Full-Pass/hexagram-{NN}.json` - Complete Legge I Ching text for all 6 lines (zero-padded)
...
- Read the **COMPLETE** Line Companion text from `gate-{N}-full.json`
- Read the **COMPLETE** Legge I Ching text from `hexagram-{NN}.json`
