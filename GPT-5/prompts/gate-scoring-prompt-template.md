...
- Read the **COMPLETE** Legge I Ching text from `hexagram-{N}.json`
...
**Source**: `hexagram-{N}.json`, same line number as gate.line
...
```
ERROR: Weight >0.50 requires Legge quote from same line for {N}.{L}
Cannot proceed without I Ching textual anchor.
```
**STOP. Do not proceed.**
